...
12 REM
13 FOR I=0 TO 6 : A = PEEK($9F34+I) : POKE $9F2D+I,A : NEXT I
14 REM
...
59 POKE $9F29,$31                        : REM ENABLE LAYER 1,2
60 POKE $9F34,$68                        : REM SET LAYER1 AS 1BPP TEXT, T256C
61 POKE $9F35,$20                        : REM $004000 FOR LAYER 1 TILE MAP
70 POKE $9F36,$40                        : REM USE $008000 AS TILE DATA AREA
80 FOR I=0 TO 41 :READ A : POKE $9000+I,A : NEXT I
85 SYS $9000
90 FOR I=0 TO 43 :READ A : POKE $9100+I,A : NEXT I
95 SYS $9100
100 REM
...
160 NEXT I
200 REM
201 REM == Fill the tile map with blank tiles ==
202 REM
210 REM POKE $9F20,0:POKE $9F21,$40:POKE $9F22,$10
220 REM FOR I=1 TO 64*128 : POKE $9F23,81: POKE $9F23,0 : NEXT I
300 REM
...
403 REM
410 REM POKE $9F20,0:POKE $9F21,0:POKE $9F22,$10
...
1040 POKE $9F39,L : POKE $9F3A,H           : REM UPDATE LYR 1 VSCROLL REGISTERS
1050 C=INT(255*RND(1)) : VPOKE $1,$FBFE,C
1060 F=F+1 : IF F>5 THEN F=0         : REM CYCLE ZAP ANIMATION FRAME 0..5
1070 REM POKE $9F36,F*16              : REM MOVE CHR DATA POINTER (32BYTE/FRAME)
...
1100 POKE $9F32,L : POKE $9F33,H
9900 GET K$ : IF K$="" THEN 1020     : REM CHECK FOR KEYPRESS TO EXIT
9910 POKE $9F29,$11                : REM HIDE LAYER 1
9920 POKE $9F32,0 : POKE $9F33,0 : REM RESET H/VSCROLL ON LAYER 0
9930 PRINT "\XF4"
9999 END
...
12000 REM
12001 REM - MACHINE CODE FOR LAYER 1 QUICK FILL
12002 REM
12010 DATA 120        : REM SEI
12040 DATA 169,0      : REM LDA #$00  ;
12050 DATA 141,32,159 : REM STA $9F20 ;
12051 DATA 169,64      : REM LDA #$40  ;
12060 DATA 141,33,159 : REM STA $9F21 ;
12020 DATA 169,16     : REM LDA #$10  ; SET VERA POINTER TO 00:0000 STEP 1
12030 DATA 141,34,159 : REM STA $9F22 ;
12070 DATA 162,0    : REM LDX #$0  ; COLOR CODE
12080 DATA 169,64     : REM LDA #$40
12090 DATA 133,31    : REM STA $1F   ; SET $1F TO 64 (64 ROWS OF TILES)
12100 DATA 169,0     : REM LDA #$0  ; TILE CODE
12110 DATA 198,31    : REM DEC $1F
12120 DATA 48,14      : REM BMI $9128 ; JMP TO END IF DONE WITH 64 ROWS
12130 DATA 160,128    : REM LDY #$80  ; SET Y INDEX  TO 128 COLUMNS
12140 DATA 136        : REM DEY
12150 DATA 48,247     : REM BMI $9118 ; LOOP TO NEXT ROW IF DONE W/ 128 COLS
12160 DATA 141,35,159 : REM STA $9F23 ; PUSH TILE TO VRAM
12170 DATA 142,35,159 : REM STX $9F23 ; PUSH COLOR TO VRAM
12180 DATA 76,30,145  : REM JMP $911E
12190 DATA 88         : REM CLI
12200 DATA 96         : REM RTS
