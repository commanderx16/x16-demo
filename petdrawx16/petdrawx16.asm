...
CSS01:
	...
	LDY #00
	STZ	VERA_addr_med
	STZ	VERA_addr_low		;SET STARTING POSITION
	LDA	#<CHAR_SEL_SCREEN_TEXT+2
	STA	TMP1
	LDA	#>CHAR_SEL_SCREEN_TEXT
	STA	TMP2
	LDA	#<CHAR_SEL_SCREEN_COLOR+2
	STA	TMP3
	LDA	#>CHAR_SEL_SCREEN_COLOR
	STA	TMP4
	JSR	SCREENCOPY
...
PX:
	.byte	$00	; X-Location (0-79)
PY:
	.byte	$00	; Y-Location (0-49)
PIXEL:
	.byte	$00	; CURRENT 4-BIT PIXEL
PIXEL2:
	.byte	$00	; TEMP
...
CLEAR_SCREEN:
	...
	LDA #$10		; Set stride increment to 1
	STA	VERA_addr_high
...
HS01:
	...
	LDY	#00
	STY	VERA_addr_med
	STY	VERA_addr_low		;SET STARTING POSITION
...
HS04:
	...
	LDY	#00
	CLC
	LDA	TMP1		;INCREASE ORIGIN TEXT BY 40 CHARACTERS
	ADC	#40
	STA	TMP1
	LDA	TMP2
	ADC	#$00
	...
	STA TMP4
	INX
	STX	VERA_addr_med	;SET NEW LINE ON VIDEO RAM
	LDA	#$00
	STA	VERA_addr_low
	CPX	#25
	BNE	HS04
...
CS02:
	...
	STA	TMP1
	LDA	#>COLOR_SCREEN_TEXT
	STA	TMP2
	LDA	#<COLOR_SCREEN_COLOR+2
	STA	TMP3
	LDA	#>COLOR_SCREEN_COLOR
	STA	TMP4
	JSR	SCREENCOPY
	JSR COLBANKHILITE
	JSR	FGCOLORHILITE
...
;to have the starting position set for VERA_addr_low and VERA_addr_med
;first, and also needs VERA_addr_high set to 0.
...
SAMPLE_COLOR_DISPLAY:
	...
	STA	VERA_addr_high	;START POSITION X=16 Y=12
	LDY	#12
SCD01:
	LDA	#33
	STA	VERA_addr_low
...
LOAD_SAVE_MENU:
	...
	JSR	SET40
	LDA	#$01	;WHITE
	STA	CURRENT_SCREEN_COLOR 	;CURRENT COLOR
	JSR	CLEAR_SCREEN
	LDY	#0
LSM01:
	LDA	TEST_TEXT,Y
...
SAVE_ROUTINE:
	...
	LDA	#>SCREEN_BUFFER
	STA	TMP2
	LDA	#TMP1	;START LOCATION STORED AT TMP1
...
MODEX:
	.byte 128,128,64,64,32,32
MODEY:
	.byte 128,64,128,64,64,32
SIZEX:
	.byte 80,80,40,40,20,20
SIZEY:
	.byte 60,30,60,30,30,15

FSIZE_H:
	.byte $25,$12,$12,$09,$04,$02
FSIZE_L:
	.byte $80,$C0,$C0,$60,$B0,$58
...
XLOC:
	.byte	$00	;X Coordinate (0-39)
YLOC:
	.byte	$00	;Y Coordinate (0-24)
PCHAR:
	.byte	$00	;Character (0-255)
PCOL:
	.byte	$00	;Color (0-15)
SELCHAR:
	.byte	$00	;SELECTED CHAR
SELCOL:
	.byte	$01	;SELECTED COLOR
...
COLTEMP:
	.byte	$01
PXCRST:
	.byte	$00	;PIXEL CURSOR STATE (0 OR 1)
CRXTIMER:
	 .byte	$00
CRXTIM2:
	.byte	$00
SCR_SIZE_X:
	.byte	ROW_80	;	screen size X (20, 40, or 80)
SCR_SIZE_Y:
	.byte	ROW_60 ;	screen size Y (15, 30, or 60)
CHAR_SEL_X:
	.byte	$00 ;	location of character select cursor
CHAR_SEL_Y:
	.byte	$00 ;
CHAR_SEL_MIN_X:
	.byte	23		;These are used to determine the window
CHAR_SEL_MAX_X:
	.byte	38		;or "bank" that the character select screen 
CHAR_SEL_MIN_Y:
	.byte	09		;is currently confined to.
CHAR_SEL_MAX_Y:
	.byte	23		;
CHAR_SEL_COLOR:
	.byte	$01		;Color of char select cursor
CHAR_SEL_NORM:
	.byte	$06		;normal color of char select screen
CRSR_OLD_COL:
	.byte	$00 	;Color before cursor was plotted
COLSEL_FG:
	.byte	$00		;Foreground color selection
COLSEL_BG:
	.byte	$00		;background color selection
COLSEL_BANK:
	.byte	$00		;0=Left 1=right selection
NAME_LENGTH:
	.byte	0		;Length of filename
FILE_NAME:
	.byte	"                "
DEVICE_NUMBER:
	.byte	$08		;DISK DRIVE DEVICE #94
TEXT_MODE:
	.byte	03		;DEFAULT 3=40X30
SHIFT_TEMP1:
	.byte	00
SHIFT_TEMP2:
	.byte	00
COPY_WIDTH:
	.byte	80		;Width of screen (IN BYTES) for copy purposes
COPY_HEIGHT:
	.byte	30		;height of copy process
...
CHAR_SEL_SCREEN_TEXT:
	.incbin "pdcharsel_text.bin"
CHAR_SEL_SCREEN_COLOR:
	.incbin "pdcharsel_color.bin"
HELP_SCREEN_TEXT:
	.incbin "x16help_text.bin"
HELP_SCREEN_COLOR:
	.incbin "x16help_color.bin"
COLOR_SCREEN_TEXT:
	.incbin "pdcolpick_text.bin"
COLOR_SCREEN_COLOR:
	.incbin "pdcolpick_color.bin"
