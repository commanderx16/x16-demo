...
2 REM *** ADAPTED TO R37 AND VERA 0.9      15.08.2020 ***
3 REM ***               BY SERERRIS                   ***
...
104 NEXT:RETURN
10000 REM PLOT PIXEL (1-2)
10010 XP=INT(X/4):CV=XD(X AND 3)
10020 PO=$4000+Y*WI+XP:VPOKE 0, PO, VPEEK(0,PO) OR CV
10030 RETURN
10100 REM PLOT PIXEL (0)
10110 XP=INT(X/4):CV=XD(X AND 3)
10120 PO=$4000+Y*WI+XP:VPOKE 0, PO, VPEEK(0,PO) AND (255-CV)
10130 RETURN
20000 REM SETUP SCREEN SCALING 2X
20010 POKE $9F2B,64:POKE $9F2A,64
20020 REM SETUP BITMAP MODE AND START ADDRESS $4000
20030 POKE $9F2F,$20:POKE $9F2D,$05:POKE $9F29,PEEK($9F29) OR $10
20040 REM SETUP PALLETE
20050 READ CGB,CR:B=0:GOSUB 20200
20060 READ CGB,CR:B=1:GOSUB 20200
20070 READ CGB,CR:B=2:GOSUB 20200
20080 READ CGB,CR:B=3:GOSUB 20200
20090 COLOR 12,0 :PRINT CHR$(147);
20100 REM CLEAR BITMAP
20101 POKE $9F21,$40:POKE $9F20,$00:POKE $9F22,$10
20102 FOR I=0 TO $4B00
20103 POKE $9F23,$FF:NEXT
20110 RETURN
20200 REM SET COLOR TO COLOR IN SLOT B
20210 VPOKE 1,$FA00+B*2,CGB
20220 VPOKE 1,$FA00+B*2+1,CR
20230 RETURN
40000 REM PALLETTE DEFINITION (2BIT=4COLORS)
40010 DATA $FE,$B,$88,$8,$44,$4,$11,$1
